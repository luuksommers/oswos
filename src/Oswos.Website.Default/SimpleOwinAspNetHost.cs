...
namespace Oswos.Website.Default
{
    ...
    public class SimpleOwinAspNetRouteHandler : IRouteHandler
    {
        ...
        public SimpleOwinAspNetRouteHandler(Func<IDictionary<string, object>, Task> app)
            : this(app, null)
        {
        }

        public SimpleOwinAspNetRouteHandler(Func<IDictionary<string, object>, Task> app, string root)
        {
            this.simpleOwinAspNetHandler = new SimpleOwinAspNetHandler(app, root);
        }

        public SimpleOwinAspNetRouteHandler(IEnumerable<Func<Func<IDictionary<string, object>, Task>, Func<IDictionary<string, object>, Task>>> apps)
            : this(apps, null)
        {
        }

        public SimpleOwinAspNetRouteHandler(IEnumerable<Func<Func<IDictionary<string, object>, Task>, Func<IDictionary<string, object>, Task>>> apps, string root)
        {
    ...
    public class SimpleOwinAspNetHandler : IHttpAsyncHandler
    {
        ...
        public SimpleOwinAspNetHandler(Func<IDictionary<string, object>, Task> app)
            : this(app, null)
        {
        }

        public SimpleOwinAspNetHandler(Func<IDictionary<string, object>, Task> app, string root)
        {
            if (app == null)
            {
        ...
        public SimpleOwinAspNetHandler(IEnumerable<Func<Func<IDictionary<string, object>, Task>, Func<IDictionary<string, object>, Task>>> apps)
            : this(apps, null)
        {
        }

        public SimpleOwinAspNetHandler(IEnumerable<Func<Func<IDictionary<string, object>, Task>, Func<IDictionary<string, object>, Task>>> apps, string root)
            : this(ToOwinApp(apps), root)
        {
        }

        public static Func<IDictionary<string, object>, Task> ToOwinApp(IEnumerable<Func<Func<IDictionary<string, object>, Task>, Func<IDictionary<string, object>, Task>>> apps)
        {
            if (apps == null)
